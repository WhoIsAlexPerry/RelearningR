...
Later on, we'll learn about piping, another form of notation. 
...
Categorical Variable - Bar charts with a number (count) on the y axis. And a discrete variable on the x axis. 
...
ggplot(penguins, aes(x = species)) +
  ...
  we order it from highest to lowest. 
